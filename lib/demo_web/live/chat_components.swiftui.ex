defmodule DemoWeb.Components.SwiftUI do
  ...
  attr :channel, Demo.Localites.Localite, required: true
  attr :users_fun, :any
  ...
  attr :user, Demo.Accounts.User, required: true
  ...
  attr :user, Demo.Accounts.User
  attr :online_fun, :any, required: true
  attr :current_user, Demo.Accounts.User
  slot :inner_block

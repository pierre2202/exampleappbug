defmodule DemoWeb.Router do
  alias DemoWeb.ModerationLive
  alias DemoWeb.DemoWeb.ProfilLive
  alias DemoWeb.IndexLive
  alias DemoWeb.ChatLive
  alias DemoWeb.ShowLive
  use DemoWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout,
      html: {DemoWeb.Layouts, :root},
      swiftui: {DemoWeb.Layouts.SwiftUI, :root}
  ...
  scope "/", DemoWeb do
    pipe_through [:browser]
    get "/users/test2", PageController, :home
